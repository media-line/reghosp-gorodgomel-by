...
class CkformsViewCkform extends JView
{
	...
	function display($tpl = null)
	{
		...
		$document->addScript(JURI::root(true).'/administrator/components/com_ckforms/js/jquery-1.3.2.min.js');
		$document->addScript(JURI::root(true).'/administrator/components/com_ckforms/js/ui.core.min.js');
		$document->addScript(JURI::root(true).'/administrator/components/com_ckforms/js/ui.tabs.min.js');

		$document->addStyleSheet(JURI::root(true).'/administrator/components/com_ckforms/css/jquery.tabs.css');
