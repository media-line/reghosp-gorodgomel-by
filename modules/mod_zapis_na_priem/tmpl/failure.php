...
<div class="zapis">
    <form action="" method="post">
        ...
        <input type="submit" name="submit" value="Отказаться от записи на прием">
        <input type="hidden" name="failure">

        <div id="text">
            <p style="color:rgb(255, 102, 0); font-size: 12px;">Поля помеченные * обязательны для заполнения.</p>
        </div>
    </form>
</div>